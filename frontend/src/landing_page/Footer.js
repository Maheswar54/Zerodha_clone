...
function Footer() {
    return ( 
        <div className="container border-top mt-5" style={{backgroundColor:"skyblue"}}>
            <div className='row mt-5'>
                <div className='col-3'>
                <img src='media\images\logo.svg' style={{width:"50%"}} alt= "logo"/>
                <p> &copy; 
                    2010 - 2024, Zerodha Broking Ltd.All rights reserved.</p>
                </div>
                <div className='col-3'>
                <p>company</p>
                ...
                <a href="" style={{textDecoration:"none"}}>How to file a complaint?(CSR)</a><br/>
            ...
            <div className="mt-5 fs-10 text-muted" style={{fontSize:"14px"}}>
